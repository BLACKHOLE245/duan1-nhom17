<title>Poly Mobile | Thanh Toán</title>
        ...
        <form method="POST" class="content-right">
            ...
            <section style="display: flex;">
                <section style="width: 50%">
                    ...
                    <input class="input-text" id="name" name="name" type="text" placeholder="Nhập tên của bạn" required
                        value="<?php echo " $hoTen"; ?>">
                </section>

                <section style="width: 50%">
                    <label>Số Điện Thoại:</label> <br>
                    <input class="input-text" id="SDT" name="SDT" type="text" placeholder="Your number..." required
            ...
            <section style="display: flex;  margin-top: 20px">
                <section style="width: 50%">
                    ...
                    <input class="input-text" id="street" name="street" type="text" placeholder="Your street name..."
                        required value="<?php echo " $soNhaTenDuong"; ?>">
                </section>

                <section style="width: 50%">
                    <label>Phường/ Xã:</label> <br>
                    <input class="input-text" id="wards" name="wards" type="text" placeholder="Your wards..." required
                        value="<?php echo " $phuongXa"; ?>">
                </section>
            </section>
            ...
            <section style="display: flex;  margin-top: 20px">
                <section style="width: 50%;">
                    ...
                    <input class="input-text" id="district" name="district" type="text" placeholder="Your district..."
                        required value="<?php echo " $quanHuyen"; ?>">
                </section>

                <section style="width: 50%">
                    <label>Tỉnh/ Thành Phố:</label> <br>
                    <input class="input-text" id="city" name="city" type="text" placeholder="Your city..." required
                        value="<?php echo " $thanhPho"; ?>">
                </section>
            </section>

            <section style="margin-top: 10px">
                <label>Lưu Ý Cho Poly Shop:</label> <br>
                <textarea name="note" id="note" cols="30" rows="1" placeholder="VD: xin info chủ quán vì quá đẹp zaiii..."></textarea>
            </section>
            <section style="display: flex; margin: 20px 50px 0 0; justify-content: space-between;">
                ...
                <div class="form-des-cart-right">
                    ...
                    <div style="display: flex; margin-top: 3px">
                        <input type="checkbox" checked> <p style="margin-left: 5px; white-space: nowrap;">Thanh toán khi nhận hàng (COD)</p>
                    </div>
                    <div style="display: flex; margin-top: 3px">
                        <input type="checkbox" checked> <p style="margin-left: 5px; white-space: nowrap;">Thanh toán chuyển khoản</p>
                    </div>
                </div>
            </section>
