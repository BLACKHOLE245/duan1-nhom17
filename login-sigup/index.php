...
<head>
    ...
    <title>Poly Mobile | Login - Register</title>
</head>
    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form method="POST">
                ...
                <input name="user_name" type="text" placeholder="Tên đăng nhập" required>
                <input name="email" type="email" placeholder="Email" required>
                <input name="pass_word" type="password" placeholder="Mật khẩu" required>
...
<style>
    ...
    .container-back-home button{
        background: linear-gradient(to bottom right, #221f20, #5a5758, #d02f2f, #EEE5DE);
        padding: 15px 45px;
        border: none;
        border-radius: 10px;
    }
